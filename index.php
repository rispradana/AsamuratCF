...
<html><head>
    ...
    <base href="http://localhost/asamuratcf/">
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-lg"><b></i>Sispak Asam Urat CF</b></span>
        </a>
        <!-- Header Navbar -->
                      ...
                      <li class="user-header">
                        ...
                        <p>
                         Login sebagai <?php echo ucfirst($_SESSION['username']); ?>
                          <small>Pakar dari Sispak Asam Urat</small>
                        </p>
                      </li>
                      <!-- Menu Body -->
                      <!-- Menu Footer-->
    ...
    <div class="modal-dialog">
        <div class="modal-content" style="max-width: 450px;">
            ...
            <div class="modal-header mdl-kontak">
                ...
                <h4 class="text-ket" id="labelModalKu"><i class="fa fa-envelope-square"></i>Kontak Saya</h4>
            </div>
            <!-- Modal Body -->
...
function kirimContactForm(){
    ...
    if(nama.trim() == '' ){
        ...
        <strong><div class="cinta">Copyright © 2021 - Made by Antonius Adrian</a></div></strong>
      </footer>
